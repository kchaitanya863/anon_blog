jQuery(document).ready(function($) {	
    ...
    /**
     * Slider query for range
     */

    $( ".ab-control-range-size" ).each(function(){
        $self = $(this);
        $self.slider({
            range: "min",
            ...
            slide: function( event, ui ) {
                $self.prev( ".ab-range-value-size" ).text( ui.value );

                var setting = $self.prev( ".ab-range-value-size" ).attr( 'data-customize-setting-link' );
