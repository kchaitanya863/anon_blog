<div class="two-col">
	<div class="support-process col">
		...
		<p><?php printf(esc_html__('Read the detailed documentation of the theme. The documentation contain all the necessary information required to setup the theme %s.', 'vmag'), $this->theme_name ); ?></p>
